...
public class fob_result extends AppCompatActivity {
    ...
    TextView fob_resultTV,fob_resultTime;
    ...
    private class AsyncRetrieve extends AsyncTask<String,String,String>{
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                url = new URL("http://140.116.226.182/mems_client/355758080228806/upp.php");
