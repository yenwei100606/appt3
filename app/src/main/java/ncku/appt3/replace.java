...
public class replace extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(Data == null){
            Toast.makeText(replace.this, "Sorry , take picture again", Toast.LENGTH_SHORT).show();
        }
        imagepath = Data.getString("picpath2");
        replaceResult.setText(imagepath);
        imei();
        uploadServerUri = "http://140.116.226.182/mems_main/replace_1.0.php?imei="+imeipost;
    ...
    private void imei(){
        ...
        if(ContextCompat.checkSelfPermission(replace.this, Manifest.permission.READ_PHONE_STATE) != PackageManager.PERMISSION_GRANTED
                || ContextCompat.checkSelfPermission(replace.this, Manifest.permission.READ_PHONE_STATE) == PackageManager.PERMISSION_DENIED){
            ActivityCompat.requestPermissions(replace.this, new String[]{Manifest.permission.READ_PHONE_STATE}, 1);
        }else{
    ...
    private void nextpage(){
        Intent i = new Intent(this,fob_result.class);
        System.gc();
